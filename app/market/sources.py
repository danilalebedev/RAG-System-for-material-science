...
SOURCE_REGISTRY: tuple[MarketSource, ...] = (
    MarketSource(
        ...
        source_type="company",
        commodities=["nickel", "copper", "palladium", "platinum", "company financials"],
    ...
    MarketSource(
        ...
        source_type="company",
        commodities=["aluminium", "alumina", "company financials"],
    ...
    MarketSource(
        ...
        source_type="company",
        commodities=["steel", "iron ore", "company financials"],
    ...
    MarketSource(
        ...
        source_type="company",
        commodities=["steel", "company financials"],
        entities=["nlmk", "нлмк"],
        reliability_rank=84,
    ),
    MarketSource(
    ...
    MarketSource(
        ...
        source_type="company",
        commodities=["iron ore", "steel", "company financials"],
        entities=["metalloinvest", "металлоинвест"],
        reliability_rank=84,
    ),
    MarketSource(
        source_id="water_treatment_economics",
        source_name="Water treatment techno-economic demo ranges",
        source_url="local://demo/water-treatment-techno-economic-ranges",
        source_type="engineering_reference",
        commodities=["water treatment"],
        entities=[
            "water treatment",
            "water preparation",
            "desalination",
