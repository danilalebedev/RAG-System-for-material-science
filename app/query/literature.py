...
Структура: 1) где локальная база подтверждает мировую практику; 2) что есть только локально; 3) что добавляет внешняя литература; 4) пробелы и риски; 5) какие статьи стоит изучить первыми.
